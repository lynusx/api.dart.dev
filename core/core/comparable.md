...
The [Comparable] interface should be used for the natural ordering of a type. If a type can be ordered in more than one way, and none of them is the obvious natural ordering, then it might be better not to use the [Comparable] interface, and to provide separate [Comparator]s instead.

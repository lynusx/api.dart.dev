...
For more information about how to use the built-in types, refer to [Built-in Types](https://dart.dev/language/built-in-types).

Also, check out the [introduction to `dart:core`](https://dart.dev/libraries/dart-core) for more coverage of types in this library.

The [Dart Language Specification](https://dart.dev/resources/language/spec) provides technical details.
